  ...
  <div class="approve">
    ...
    <div>
      <el-table :data="tableData" border style="width: 100%" :fit="true"
        ...
        <el-table-column prop="content" label="申请理由" :show-overflow-tooltip="true"></el-table-column>
    ...
    >
      <div class="dialog-content">
        ...
        >
          <el-form-item label="是否同意" prop="checkState">
             <el-radio-group v-model="ruleForm.checkState">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="submitForm('ruleForm')">审 核</el-button>
      </div>
    </el-dialog>
  </div>
</template>
  ...
  methods:{
    ...
    submitForm(formName){
      this.$refs[formName].validate((valid) => {
        if (valid) {
          CheckApply(this.ruleForm).then(res=>{
